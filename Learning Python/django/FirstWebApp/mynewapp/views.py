...
def catalog(request):
    ...
    return render(request, 'mynewapp/catalog/list.html',{'products': products})
...
def flowers(request):
    ...
    return render(request, 'mynewapp/catalog/list.html',{'products': flowers})
...
def customers(request):
    ...
    return render(request, 'mynewapp/crm/customers.html',{'customers': customers})