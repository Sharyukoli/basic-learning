...
############### Window ICON #####################  ↓
  ...
  #p1 = tk.PhotoImage(file=r"C:\Users\HP\Downloads\New folder\ETSS_Project")
p1 = tk.PhotoImage(file=r"C:\Users\HP\Downloads\New folder\ETSS_Project\image.png")

root.iconphoto(False, p1)

################# LOGO  #########################  ↓

f_img = tk.PhotoImage(file=r"C:\Users\HP\Downloads\New folder\ETSS_Project\image.png")
